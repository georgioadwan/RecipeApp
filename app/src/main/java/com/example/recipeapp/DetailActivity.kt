...
class DetailActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imgToolbar = findViewById<ImageButton>(R.id.imgToolbarBtnBack)
        imgToolbar.setOnClickListener {
            finish()
        }

        val btnYt = findViewById<TextView>(R.id.btnYoutube)
    ...
    fun getSpecificItem(id:String) {
        ...
        call.enqueue(object : Callback<MealResponse> {
            ...
            override fun onResponse(
                ...
                tvCat.text = response.body()!!.mealsEntity[0].strmeal
                ...
                val tvIng = findViewById<TextView>(R.id.tvIngredients)
                val tvIns = findViewById<TextView>(R.id.tvInstructions)
                tvIng.text = ingredient
                tvIns.text = response.body()!!.mealsEntity[0].strinstructions
